...
public interface IUserRepository extends JpaRepository<User,Long> {
    ...
    @Query("SELECT b FROM User b WHERE CONCAT(b.email, ' ', b.name, ' ', b.username) LIKE %:keyword%")
    public Page<User> Search(Pageable page, @Param("keyword")String keyword);

    @Query("SELECT b FROM User b")
    Page<User> findWithOutDelete(Pageable page);
}
